...
const COMPANY_GRADIENTS = [
  ...
  "from-slate-700 to-sky-500",
  "from-orange-600 to-rose-500",
  "from-emerald-700 to-lime-500",
  "from-cyan-700 to-teal-500",
  "from-amber-600 to-orange-500",
  "from-stone-600 to-teal-700",
];

const BANNER_GRADIENTS = [
  "from-stone-950/80 via-teal-950/30 to-black",
  "from-amber-950/80 via-stone-900/30 to-black",
  "from-emerald-950/80 via-lime-950/25 to-black",
  "from-slate-950/80 via-cyan-950/25 to-black",
];
    ...
    <div className="h-screen w-full bg-[#0d0d0d] text-white font-sans flex flex-col overflow-hidden selection:bg-blue-500/30">
      ...
      <footer className="h-10 border-t border-white/5 bg-[#090909] shrink-0 flex items-center justify-between px-5 text-[11px] font-semibold text-gray-500 z-20">
        <div className="flex items-center gap-5">
          ...
          <span>Midnight Ledger Network</span>
        ...
        <div className="flex items-center gap-5">
          ...
          <div className="flex items-center gap-1.5 text-blue-400 bg-blue-500/10 px-2.5 py-1 rounded-full border border-blue-500/20">
            ...
            <span className="font-bold">Midnight Ledger Proofs</span>
          </div>
          <div className="w-px h-4 bg-white/10" />
